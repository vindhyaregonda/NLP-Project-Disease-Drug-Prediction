...
import os
# os.environ["CUDA_VISIBLE_DEVICES"]="AVAILABLE_CUDA_DEVICE"
os.chdir("/Data")
...
# Example usage:
csv_file ='/raid/home/seraj22200/data_form/df_train_20.csv'
...
class BertClassifier(nn.Module):
    def __init__(self, num_classes1, num_classes2):
        ...
        self.bert = BertModel.from_pretrained('/raid/home/seraj22200/data_form/my_model')
...
def train_epoch(model, dataloader, optimizer, criterion, device):
    ...
    for batch_idx, batch in progress_bar:
        ...
        target1 = batch['rating'].type(torch.LongTensor).to(device)
...
for epoch in range(num_epochs):
    ...
    print(f'Train Loss: {train_loss:.4f}, Train Accuracy Target 2: {train_accuracy1:.4f}, Train F1 Score Target 2: {train_f1_1:.4f}') #, Train Accuracy Target 2: {train_accuracy2:.4f}, Train F1 Score Target 2: {train_f1_2:.4f}')
    print(f'Val Loss: {val_loss:.4f}, Val Accuracy Target 2: {val_accuracy1:.4f}, Val F1 Score Target 2: {val_f1_1:.4f}')#, Val Accuracy Target 2: {val_accuracy2:.4f}, Val F1 Score Target 2: {val_f1_2:.4f}')

# model.save_pretrained('rating_bng_mymodel')
# model.save_pretrained('c_bert')
model_path = "rating_bng_mymodel.pth"
