...
class CustomDataset(Dataset):
    def __init__(self, csv_file, label_encoders):
        ...
        self.target1 = self.data['drugName'].tolist()
...
import pandas as pd
pd.read_csv("/Data/df_train_20.csv")
...
# model.save_pretrained('m_bert')
model_path = "base_bert.pth"
