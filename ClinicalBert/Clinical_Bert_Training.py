...
import torch
os.chdir("/raid/home/seraj22200/data_form")
torch.manual_seed(0)
...
# Example usage:
csv_file = '/raid/home/seraj22200/data_form/df_train_20.csv'  # Replace 'your_data.csv' with the path to your CSV file
...
import pandas as pd
pd.read_csv("/source/uncased/df_train_20.csv")
...
class BertClassifier(nn.Module):
    def __init__(self, num_classes1, num_classes2):
        ...
        self.bert = BertModel.from_pretrained('medicalai/ClinicalBERT')
